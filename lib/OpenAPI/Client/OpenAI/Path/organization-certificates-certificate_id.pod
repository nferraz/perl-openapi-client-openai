...
=item * C<certificate_id> (in path) (Required) - Unique ID of the certificate to delete.
...
=item * C<certificate_id> (in path) (Required) - Unique ID of the certificate to modify.
