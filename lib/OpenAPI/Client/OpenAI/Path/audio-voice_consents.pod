...
This document describes the API endpoint at C</audio/voice_consents>.

=head1 PATHS


=head2 C<GET /audio/voice_consents>
...
See the L<custom voices guide|https://platform.openai.com/docs/guides/text-to-speech#custom-voices>. Custom voices are limited to eligible customers.
...
=head2 C<POST /audio/voice_consents>
...
See the L<custom voices guide|https://platform.openai.com/docs/guides/text-to-speech#custom-voices> for requirements and best practices. Custom voices are limited to eligible customers.



=head3 Operation ID

C<createVoiceConsent>

    $client->createVoiceConsent( ... );
