...
This document describes the API endpoint at C</realtime/calls/{call_id}/refer>.

=head1 PATHS


=head2 C<POST /realtime/calls/{call_id}/refer>
...
C<refer-realtime-call>

    $client->refer-realtime-call( ... );
